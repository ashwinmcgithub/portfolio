    ...
    <section className="relative w-full h-screen bg-black overflow-hidden flex">
      ...
      <div className="relative z-10 flex-1 flex flex-col justify-center px-8 md:px-16 lg:px-24 pt-16">
        ...
        <p className="mt-6 text-neutral-400 text-base md:text-lg max-w-[420px] leading-relaxed">
          Building immersive digital experiences — from interactive 3D worlds to
        ...
        <div className="mt-10 flex flex-wrap items-center gap-4">
          ...
          >
            ...
            <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
              <path d="M2.5 7H11.5M7 2.5L11.5 7L7 11.5" stroke="black" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
          </a>
          <a
            href="#contact"
